...
.to(".circlebar", 1, {scale: 0, duration: 1, delay: 2}).to(".circlebar", {opacity: 1, scale: 1, duration: 1}, 0);
...
horizontal.to(".anim-kiri, .anim-kiri-1", 1, { opacity:0, x: "-100vh", stagger:0.1, duration: 5}, 2)
.to(".anim-kanan", 1, { opacity:0, x: "100vh", stagger:0.1, duration: 2}, 2)
...
.to(".progress-bar-1", 1, {width: "90%", duration: 1}, 4)
.to(".progress-bar-2", 1, {width: "75%", duration: 1}, 4)
.to(".progress-bar-3", 1, {width: "60%", duration: 1}, 4)
.to(".progress-bar-4", 1, {width: "50%", duration: 1}, 4)
