...
.to("#myBar", 1, {width: "5%", duration: 1}, 0)
.to(".circlebar", {opacity: 1, scale: 1, duration: 1}, 0);

horizontal.from(".anim-kiri, .anim-kiri-1", 1, { opacity:1, x: "-100vh", stagger:0.1, duration: 1}, 1)
.from(".anim-kanan", 1, { opacity:1, x: "100vh", stagger:0.1, duration: 1}, 1)
.to("#myBar", 1, {width: "25%", duration: 1}, 1);

horizontal.to(".anim-kiri, .anim-kiri-1", 1, { opacity:0, x: "-100vh", stagger:0.1, duration: 1, delay: 1.1}, 2)
.to(".anim-kanan", 1, { opacity:0, x: "100vh", stagger:0.1, duration: 1, delay: 1.1}, 2)
.to("#myBar", 1, {width: "50%", duration: 1}, 2);

horizontal.to("#ai-suggestion-new .people", 1, { opacity: 0, scale: 1, transformOrigin: "center bottom", duration: 1 }, 3)
.to("#ai-suggestion-new .people2", 1, { scale: 0.90, transformOrigin: "center bottom", duration: 1 }, 3)
.to("#ai-suggestion-new .people2", 1, { scale: 1, transformOrigin: "center bottom", duration: 1.5 }, 3)
.to("#ai-suggestion-new .people2", 1, { opacity: 1, transformOrigin: "center bottom", duration: 1 }, 3)
.to("#myBar", 1, {width: "75%", duration: 1}, 3);

horizontal.from(".anim-kiri-after", 1, { opacity:0, x: "-130vh", stagger:0.1, duration: 1}, 4)
// .to(".anim-kiri-after", 1, { opacity:1, x: "0vh", stagger:0.1, duration: 1}, 4)
.from(".progress-bar-1, .progress-bar-2, .progress-bar-3, .progress-bar-4", 1, {width: "0%", duration: 1}, 4)
.to(".progress-bar-1", 1, {width: "90%", duration: 1, delay: 1.5}, 4)
.to(".progress-bar-2", 1, {width: "75%", duration: 1, delay: 1.5}, 4)
.to(".progress-bar-3", 1, {width: "60%", duration: 1, delay: 1.5}, 4)
.to(".progress-bar-4", 1, {width: "50%", duration: 1, delay: 1.5}, 4)
.from(".anim-kanan-after", 1, { opacity:0, x: "100vh", stagger:0.1, duration: 1}, 4)
// .to(".anim-kanan-after", 1, { opacity:1, x: "0vh", stagger:0.1, duration: 1}, 4)
.to("#myBar", 1, {width: "100%", duration: 1}, 4);
